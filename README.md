...
- Installs default ClawHub skills:
  `agent-browser-clawdbot`, `agent-daily-planner`, `agent-swarm`, `agent-team-orchestration`, `self-reflection`, `joko-moltbook`, `tweet-writer`, `n8n`, and `clawtoclaw`
...
- have `agent-browser-clawdbot`, `agent-daily-planner`, `agent-swarm`, `agent-team-orchestration`, `self-reflection`, `joko-moltbook`, `tweet-writer`, `n8n`, and `clawtoclaw` installed by default
