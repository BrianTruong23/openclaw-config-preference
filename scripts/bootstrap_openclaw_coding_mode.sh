...
GOG_SKILL_SRC="${ROOT_DIR}/templates/gog.SKILL.md"
GOG_SKILL_YAML_SRC="${ROOT_DIR}/templates/gog.openai.yaml"
...
GOG_SKILL_DIR="/root/.openclaw/skills/gog"
GOG_SKILL_DST="${GOG_SKILL_DIR}/SKILL.md"
GOG_SKILL_YAML_DST="${GOG_SKILL_DIR}/agents/openai.yaml"
...
ssh "${SSH_OPTS[@]}" "${HOST}" "mkdir -p ${GOG_SKILL_DIR}/agents"
scp "${SSH_OPTS[@]}" "${GOG_SKILL_SRC}" "${HOST}:${GOG_SKILL_DST}"
scp "${SSH_OPTS[@]}" "${GOG_SKILL_YAML_SRC}" "${HOST}:${GOG_SKILL_YAML_DST}"
