...
AVAILABLE_SKILLS_DST="/root/.openclaw/workspace/AVAILABLE_SKILLS.md"
AVAILABLE_SKILLS_CODING_DST="/root/.openclaw/workspace-coding/AVAILABLE_SKILLS.md"
...
scp "${SSH_OPTS[@]}" "${AVAILABLE_SKILLS_SRC}" "${HOST}:${AVAILABLE_SKILLS_DST}"
scp "${SSH_OPTS[@]}" "${AVAILABLE_SKILLS_SRC}" "${HOST}:${AVAILABLE_SKILLS_CODING_DST}"
